...
class GigsControllerTest < ActionController::TestCase
  ...
  test "should create gig" do
    assert_difference('Gig.count') do
      post :create, gig: { date: @gig.date, description: @gig.description, event: @gig.event, location: @gig.location }
    end
  ...
  test "should update gig" do
    patch :update, id: @gig, gig: { date: @gig.date, description: @gig.description, event: @gig.event, location: @gig.location }
    assert_redirected_to gig_path(assigns(:gig))
  end
